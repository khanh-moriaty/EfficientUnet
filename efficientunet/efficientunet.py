...
def get_efficient_unet_b0(input_shape, out_channels=3, pretrained=False, block_type='transpose', concat_input=True, unet=True):
    ...
    model = _get_efficient_unet(encoder, out_channels, block_type=block_type, concat_input=concat_input, unet=unet)
    return model


def get_efficient_unet_b1(input_shape, out_channels=3, pretrained=False, block_type='transpose', concat_input=True, unet=True):
...
def get_efficient_unet_b2(input_shape, out_channels=3, pretrained=False, block_type='transpose', concat_input=True, unet=True):
...
def get_efficient_unet_b3(input_shape, out_channels=3, pretrained=False, block_type='transpose', concat_input=True, unet=True):
...
def get_efficient_unet_b4(input_shape, out_channels=3, pretrained=False, block_type='transpose', concat_input=True, unet=True):
...
def get_efficient_unet_b5(input_shape, out_channels=3, pretrained=False, block_type='transpose', concat_input=True, unet=True):
...
def get_efficient_unet_b6(input_shape, out_channels=3, pretrained=False, block_type='transpose', concat_input=True, unet=True):
...
def get_efficient_unet_b7(input_shape, out_channels=3, pretrained=False, block_type='transpose', concat_input=True, unet=True):
